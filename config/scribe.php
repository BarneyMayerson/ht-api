...
return [
    ...
    'description' => 'Habit Tracker allows you to track your habits every single day. You can feed this API to a telegram bot for example.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
        This documentation aims to provide all the information you need to work with our API.

        As you scroll, you will see code examples for working with the API in different programming languages in the dark area to the right (or as part of the content on mobile).
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Last updated: {date:d.m.Y}',
